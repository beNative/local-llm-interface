...
- **Release Notes**: The changelog view now highlights the most recent version (e.g., 0.20.0) so you can quickly review what changed before updating. Capture the same talking points while auditing documentation so the GitHub release draft mirrors the in-app notes.
