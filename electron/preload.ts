...
electron.contextBridge.exposeInMainWorld('electronAPI', {
  ...
  onUpdateDownloadProgress: (callback: any) => electron.ipcRenderer.on('update-download-progress', (_event, ...args) => callback(...args)),
  removeUpdateDownloadProgressListener: () => electron.ipcRenderer.removeAllListeners('update-download-progress'),
